...
public class AwsClientUtilsTest {
  ...
  public void testGetRoleArnCredentialsProvider_WithDifferentRegions_ReturnsProvider() {
    ...
    AwsCredentialsProvider provider1 =
        AwsClientUtils.getRoleArnCredentialsProvider(roleArn, sessionName, Region.US_EAST_1);
    AwsCredentialsProvider provider2 =
        AwsClientUtils.getRoleArnCredentialsProvider(roleArn, sessionName, Region.US_WEST_2);
